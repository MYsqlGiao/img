...
window.onload = function() {
    ...
    function flower_html() {
        ...
        flower_subunit_code += '</div>';
        let flower_subunit_code_append = document.getElementsByClassName("flower_subunit")[0];
        ...
        flower_search_code_append.innerHTML = flower_search_code;
